...
import static de.b3ttertogeth3r.walhalla.old.utils.Variables.SIGN_IN;
...
import de.b3ttertogeth3r.walhalla.old.firebase.RemoteConfig;
import de.b3ttertogeth3r.walhalla.old.fragments_main.AboutUsFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.BalanceFragment;
...
import de.b3ttertogeth3r.walhalla.old.fragments_main.FratGermanyFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.FratWueFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.GreetingFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.HistoryFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.HomeFragment;
import de.b3ttertogeth3r.walhalla.old.fragments_main.RoomFragment;
import de.b3ttertogeth3r.walhalla.old.interfaces.OpenExternal;
    ...
    private void switchPage (@NonNull Integer item) {
        ...
        switch (item) {
            ...
            case R.string.menu_program:
                ...
                fragmentManager.beginTransaction().replace(R.id.fragment_container,
                        new de.b3ttertogeth3r.walhalla.old.fragments_main.program.Fragment())
                        .addToBackStack(TAG)
                        .commit();
                break;
            case R.id.row2first:
            ...
            case R.string.menu_profile:
                ...
                fragmentManager.beginTransaction().replace(R.id.fragment_container,
                        new de.b3ttertogeth3r.walhalla.old.fragments_main.profile.Fragment())
                        .addToBackStack(TAG)
                        .commit();
                break;
            ...
            case R.string.menu_drinks:
                ...
                getSupportFragmentManager().beginTransaction().replace(R.id.fragment_container,
                        new de.b3ttertogeth3r.walhalla.old.fragments_main.drinks.Fragment())
                        .addToBackStack(TAG)
                        .commit();
                break;
            ...
            case R.string.menu_all_profiles:
                ...
                fragmentManager.beginTransaction().replace(R.id.fragment_container,
                        new de.b3ttertogeth3r.walhalla.old.fragments_main.all_users.Fragment())
                        .addToBackStack(TAG)
                        .commit();
                break;
            ...
            case R.string.menu_messages:
                ...
                fragmentManager.beginTransaction().replace(R.id.fragment_container,
                        new de.b3ttertogeth3r.walhalla.old.fragments_main.news.Fragment())
