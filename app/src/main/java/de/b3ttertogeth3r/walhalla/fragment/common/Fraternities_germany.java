...
public class Fraternities_germany extends Fragment {
    private static final String TAG = "Fraternities_germany";
    ...
    @Override
    public void start() {
        new FormatJSON(Firebase.remoteConfig().getString(RemoteConfig.FRATERNITY_GERMANY))
