...
import de.b3ttertogeth3r.walhalla.adapter.MyImageItem;
import de.b3ttertogeth3r.walhalla.design.MyEditText;
import de.b3ttertogeth3r.walhalla.design.MyImageButton;
...
public class EditChargeDialog extends DialogFragment implements DialogInterface.OnClickListener,
    ...
    public EditChargeDialog (Charge kind,
                             de.b3ttertogeth3r.walhalla.models.Charge charge) {
        this.kind = kind;
        this.charge = charge;
    }
        ...
        try {
            ...
            new SimpleSearchDialogCompat(App.getContext(), "Search...", "Search for a person",
                    ...
                    (SearchResultListener<Searchable>) (dialog, item, position) -> {
                        ...
                        de.b3ttertogeth3r.walhalla.models.Charge c =
                                new de.b3ttertogeth3r.walhalla.models.Charge(peopleList.get(position));
                        dialog.dismiss();
