package de.b3ttertogeth3r.walhalla.fragments.chargen_phil;
...
public class Fragment extends CustomFragment {
    ...
    @Override
    public void start () {
        Firebase.Firestore.getPhilChargen(CacheData.getChosenSemester(), new OnGetDataListener(){
            @Override
    ...
    private void updateList () {
        ...
        sortList();
        for(Charge b: board){
            layout.addView(new ChargenRow(getContext(), b, de.b3ttertogeth3r.walhalla.enums.Charge.find(b.getId())));
        }
